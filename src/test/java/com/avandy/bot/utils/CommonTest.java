...
public class CommonTest {
    ...
    public void checkJaroWinkler() {
        String s1 = "Путин пообещал рассмотреть предложения по улучшению перевозок между Анадырем и аэропортом";
        String s2 = "Путин пообещал рассмотреть предложение о соцгарантиях для многодетных отцов";
